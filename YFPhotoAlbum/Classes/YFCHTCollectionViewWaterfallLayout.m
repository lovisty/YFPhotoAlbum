...
NSString *const YFCHTCollectionElementKindSectionHeader = @"YFCHTCollectionElementKindSectionHeader";
NSString *const YFCHTCollectionElementKindSectionFooter = @"YFCHTCollectionElementKindSectionFooter";

@interface YFCHTCollectionViewWaterfallLayout ()
...
@implementation YFCHTCollectionViewWaterfallLayout
...
- (void)prepareLayout {
    ...
    for (NSInteger section = 0; section < numberOfSections; ++section) {
        ...
        if (headerHeight > 0) {
            attributes = [UICollectionViewLayoutAttributes layoutAttributesForSupplementaryViewOfKind:YFCHTCollectionElementKindSectionHeader withIndexPath:[NSIndexPath indexPathForItem:0 inSection:section]];
        ...
        if (footerHeight > 0) {
            attributes = [UICollectionViewLayoutAttributes layoutAttributesForSupplementaryViewOfKind:YFCHTCollectionElementKindSectionFooter withIndexPath:[NSIndexPath indexPathForItem:0 inSection:section]];
...
- (UICollectionViewLayoutAttributes *)layoutAttributesForSupplementaryViewOfKind:(NSString *)kind atIndexPath:(NSIndexPath *)indexPath {
    ...
    if ([kind isEqualToString:YFCHTCollectionElementKindSectionHeader]) {
        attribute = self.headersAttribute[@(indexPath.section)];
    } else if ([kind isEqualToString:YFCHTCollectionElementKindSectionFooter]) {
